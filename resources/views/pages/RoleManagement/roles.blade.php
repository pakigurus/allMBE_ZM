                    ...
                    <form action="{{url('admin/role')}}" method="POST" >
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control" id="example-group3-input2" name="role" placeholder="">
                ...
                <div class="col-md-6 text-center offset-3">
                    @foreach($roles as $key => $role)
                        <div class="row mt-3">
                            ...
                            <div class="col-6">
                                 <span class="">
                                     <a href="#" class="mx-3"  style="color: inherit;" data-toggle="modal" data-target="#edit_{{$key+1}}" ><i class="fa fa-pencil-alt" data-toggle="tooltip" data-placement="top" title="edit role"></i></a>
                                     <a href="#"  style="color: inherit;" data-toggle="modal" data-target="#modal-block-slideleft-{{$key+1}}" ><i class="fa fa-trash-alt" data-toggle="tooltip" data-placement="top" title="delete role"></i></a>
                                 </span>
                            </div>
                        </div>
                                        ...
                                        <form action="{{url('admin/role/'.$role->id)}}" method="POST">
                                            ...
                                            <div class="block-content font-size-sm ">
                                                <div class="text-center">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" required="" value="{{$role->name}}" class="form-control" id="example-group3-input2" name="role" placeholder="">
                                                            <div class="input-group-append">
                                                                <button type="submit" class="btn btn-primary">Submit</button>
                                                            </div>
                                                        </div>
