...
class CreateContributeWithTimesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('contribute_with_times', function (Blueprint $table) {
