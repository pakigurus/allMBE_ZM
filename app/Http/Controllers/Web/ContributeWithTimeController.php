...
class ContributeWithTimeController extends Controller
{
    ...
    {
        $contributeWithTime = ContributeWithTime::with([ 'masajid' ,'user', 'skill'])->get();
        return view('pages.Contribute.contributeWithTime', compact('contributeWithTime'));
    }
    ...
    public function store(Request $request) : JsonResponse
    {
        ...
        DB::transaction(function () use ($request){
            ...
            $contributeWithTime->masajids_id = $masajid->id;
